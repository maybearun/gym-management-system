...
<body>
    ...
    <form method="" action="#">
        ...
        <!-- retire date  -->
        <div class="form-group">
          <label for="inputRetireDate">Retire date</label>
          <input type="date" class="form-control" id="inputRetireDate">
        </div><br>
        <!-- upload pan -->
        <div class="form-group">
            <Label for="uploadPan">Upload PAN Card</Label><br>
            <input type="file" class="form-control-file" id="uploadPan">
          </div><br>
        <!-- upload aadhar -->
        <div class="form-group">
            <Label for="uploadAadhar">Upload Aadhar Card</Label><br>
            <input type="file" class="form-control-file" id="uploadAadhar">
          </div><br>
          <!-- submit button -->
          <div class="col-sm-10">
